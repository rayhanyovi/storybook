...
export default function LoginPage() {
  ...
  function routeAfterLogin(user: UserDTO, mode: ProfileMode) {
  ...
  function handleRegister(e: React.FormEvent) {
    ...
    toast.info('Sign-ups are mocked in this demo — hop in with a demo profile below to explore everything.');
  }

  return (
    <div className="min-h-screen bg-[var(--background)] px-5 py-10 md:px-10 lg:px-16">
      <div className="mx-auto grid w-full max-w-6xl gap-10 md:grid-cols-[minmax(0,1fr)_minmax(360px,420px)] md:items-center">
        ...
        <section className="mx-auto flex w-full max-w-md flex-col gap-4">
          <div className="rounded-[1.5rem] border border-[var(--line)] bg-[var(--card)] p-5 shadow-[0_18px_48px_rgba(58,46,40,0.12)] sm:p-6">
            <div className="flex items-center gap-3">
              <div className="grid h-10 w-10 place-items-center rounded-xl bg-[var(--primary)]/12 text-[var(--primary)]">
                <LogIn className="h-5 w-5" strokeWidth={2.4} />
              </div>
              <div>
                <h2 className="font-[family-name:var(--font-display)] text-2xl font-semibold leading-none text-[var(--ink)]">Welcome back</h2>
                <p className="mt-1 text-sm font-semibold text-[var(--ink-soft)]">Sign in to your library.</p>
              </div>
            </div>
          ...
          <div className="rounded-[1.5rem] border border-[var(--line)] bg-[var(--card)] p-5 shadow-[0_12px_32px_rgba(58,46,40,0.08)] sm:p-6">
            <div className="flex items-center gap-3">
              <div className="grid h-10 w-10 place-items-center rounded-xl bg-[var(--secondary)]/30 text-[var(--ink)]">
                <UserPlus className="h-5 w-5" strokeWidth={2.4} />
              </div>
              <div>
                <h2 className="font-[family-name:var(--font-display)] text-xl font-semibold leading-none text-[var(--ink)]">Create an account</h2>
                <p className="mt-1 text-sm font-semibold text-[var(--ink-soft)]">New here? Set up a parent login.</p>
              </div>
            </div>
